...
const Home: NextPage = () => {
  return (
    <main className="w-[87%] mx-auto mt-6 mb-20 md:mb-24 md:mt-[6.625rem] xm:mt-44 lg:mt-60 xm:mb-[unset]">
      <article className="text-center mx-auto max-w-[28.13rem] xm:text-left xm:mx-[unset] xm:mr-auto">
        <h5 className="font-sans-condensed text-base md:text-xl uppercase tracking-[.2em] text-fog mb-5">
          So, you want to travel to
        </h5>
        <h1 className="font-serif text-7xl md:text-12xl uppercase leading-none mb-7">
          Space
        </h1>
        <p className="leading-relaxed text-[0.8375rem] md:text-base text-fog mb-20 md:mb-36 xm:mb-11">
